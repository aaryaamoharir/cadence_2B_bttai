...
st.title("🛍️ Product Reviews Dashboard")
...
with tab1:
    # Top 20 features overall by absolute sentiment score
...
# Count of positive/negative/neutral by feature
feature_sentiment = pd.crosstab(
    filtered_df['aspect'],
    filtered_df['sentiment'].str.capitalize()
).reset_index()

# Get top 15 most mentioned features
